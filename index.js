  ...
  items: [
    {
      type: 'action',
      action: {
        type: 'message', // ประเภท action ต้องเป็น message
        label: '📱 แชร์เบอร์โทรศัพท์', // ใส่ icon ได้ด้วย
        text: 'กรุณาแตะปุ่ม "แชร์เบอร์โทรศัพท์" เพื่อดำเนินการต่อครับ' // ข้อความนี้จะถูกส่งถ้าผู้ใช้กดปุ่ม แต่จริงๆ แล้ว LINE จะเปิดหน้าแชร์เบอร์โทรให้ก่อน
      },
      // นี่คือส่วนสำคัญที่ทำให้ปุ่มนี้กลายเป็นปุ่มแชร์เบอร์โทร
      "inputOption": "openContact" 
    }
  ]
}
      });
